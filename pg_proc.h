...
DATA(insert OID = 4377 ( levenshtein_distance_optimize PGNSP PGUID 12 1 0 0 f f f t f i 3 0 16 "25 25 23" _null_ _null_ _null_ _null_ levenshtein_distance_optimize _null_ _null_ _null_ ));
DESCR("levenshtein distance optimize");
